...
- drive_extraction - Code for the application's Lambda function.
- lambda - Code use for the different steps in the data pipeline execution.
- events - Invocation events that you can use to invoke the function.
- tests - Unit tests for the application to make future testing. 
...
## Deploy the a sample application
